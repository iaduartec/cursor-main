  ...
  if (!p) {
    return (
      <div className='max-w-3xl mx-auto p-8'>
        ...
        <Link href='/proyectos' className='text-accent'>
          Volver a proyectos
        </Link>
      </div>
    );
    ...
    <div className='min-h-screen'>
      <section className='bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-800 dark:to-slate-900 py-16 px-4'>
        <div className='max-w-5xl mx-auto'>
          <Link href='/proyectos' className='text-accent hover:underline'>
            ← Volver a proyectos
          </Link>
          <h1 className='text-4xl md:text-5xl font-bold mt-4 text-primary dark:text-white'>
            {p.title}
          </h1>
          {p.image && (
