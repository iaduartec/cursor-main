...
export const metadata: Metadata = {
  ...
  description:
    'Artículos técnicos especializados sobre electricidad, informática, sonido y videovigilancia. Consejos profesionales y tendencias del sector.',
  keywords:
    'blog, electricidad, informática, sonido, videovigilancia, consejos técnicos, instalaciones',
  openGraph: {
